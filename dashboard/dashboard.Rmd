...
sliderInput(inputId = "range.animals", label = category.list.names[1],
            min = 0, max = 1, value = c(0, 1))
sliderInput(inputId = "range.cars", label = category.list.names[2],
            min = 0, max = 1, value = c(0, 1))
sliderInput(inputId = "range.celeb", label = category.list.names[3],
            min = 0, max = 1, value = c(0, 1))
sliderInput(inputId = "range.comedy.entertainment", label = category.list.names[4],
            min = 0, max = 1, value = c(0, 1))
sliderInput(inputId = "range.creative", label = category.list.names[5],
            min = 0, max = 1, value = c(0, 1))
sliderInput(inputId = "range.education", label = category.list.names[6],
            min = 0, max = 1, value = c(0, 1))
sliderInput(inputId = "range.gaming", label = category.list.names[7],
            min = 0, max = 1, value = c(0, 1))
sliderInput(inputId = "range.kids", label = category.list.names[8],
            min = 0, max = 1, value = c(0, 1))
sliderInput(inputId = "range.lifestyle.how-to", label = category.list.names[9],
            min = 0, max = 1, value = c(0, 1))
sliderInput(inputId = "range.movies", label = category.list.names[10],
            min = 0, max = 1, value = c(0, 1))
sliderInput(inputId = "range.music", label = category.list.names[11],
            min = 0, max = 1, value = c(0, 1))
sliderInput(inputId = "range.news", label = category.list.names[12],
            min = 0, max = 1, value = c(0, 1))
sliderInput(inputId = "range.sports", label = category.list.names[13],
            min = 0, max = 1, value = c(0, 1))
...
print("bubbles/treemap")
renderPlot({
  if (!is.null(values$normalized.data)) {
      d3heatmap(values$normalized.data, scale = "none", dendrogram = "none", colors = "Blues", show_grid = FALSE, Rowv = FALSE)
  }
})
```
...
renderValueBox({
  total.user.count <- nrow(values$raw.data[1])
