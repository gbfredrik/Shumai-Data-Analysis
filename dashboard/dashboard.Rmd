...
#### Categories
Filter categories by user interest.
```{r}
...
```{r}
renderValueBox({
  total.view.count <- sum(values$date.counted.data) #TODO
...
renderValueBox({
  # TODO: Call function()
  valueBox(value = "news", color = "Green", icon = "glyphicon-thumbs-up")
})
```
...
renderValueBox({
  # TODO: Call function()
  valueBox(value = "webcam", color = "Maroon", icon = "glyphicon-thumbs-down")
})
```
